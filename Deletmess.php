...
<body>
    ...
    <nav>
        ...
        <table>
            <tr>
                <td>
                    <img src="Images/Screenshot_2023-10-25_170246-transformed.png" alt="Logo" height="60px"
                        width="60px">

                </td>
                <td>

                    <span>ACCOMMOGATE</span>
                </td>
            </tr>
        </table>
        </div>
    ...
    <tr>
	  ...
	  <table border=0 height="80%" width="100%">
	    <tr><td><a href="Dashboard.php">Dashboard</a></td><td width="80%"rowspan="7" valign="top">
		   ...
		   <h2><a href="users.php"> </a> Deactivate Message</h2> 
		   <hr/> 
		   <?php
		...
		<?php
          ...
          if(isset($_POST['up'])){	 
		    $q = "DELETE FROM comments_tb  WHERE id=".$id; 
			$results = mysqli_query($conn,$q);   
			if (!$results){
			   die("Something went wrong.".mysqli_error($conn));
			} 
